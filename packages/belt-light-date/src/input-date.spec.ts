...
describe('dateToInputDateTime', () => {
  it('String', () => {
    ...
    // local
    assert.strictEqual(dateToInputDateTime('2015/12/25'), isParisTZ ? '2015-12-25T00:00' : '2015-12-25T01:00');
...
describe('inputDateTimeToDate', () => {
  it('String', () => {
    ...
    // - => Iso
    assert.strictEqual(inputDateTimeToDate('2015-12-25T19:30').toISOString(), isParisTZ ? '2015-12-25T17:30:00.000Z' : '2015-12-25T19:30:00.000Z');
    // / => Local
    assert.strictEqual(inputDateTimeToDate('2015/12/25T19:30').toISOString(), isParisTZ ? '2015-12-25T17:30:00.000Z' : '2015-12-25T19:30:00.000Z');
