...
describe('inputDateToDate', () => {
  it('String', () => {
    // - => Iso
    assert.strictEqual(inputDateToDate('2015-12-25').toISOString(), '2015-12-24T23:00:00.000Z');
    // / => Local
    assert.strictEqual(inputDateToDate('2015/12/25').toISOString(), '2015-12-24T23:00:00.000Z');
    assert.strictEqual(inputDateToDate('2018-06-12').toISOString(), '2018-06-11T22:00:00.000Z');
  });
});
...
describe('dateToInputDateTime', () => {
  it('String', () => {
    // iso
    assert.strictEqual(dateToInputDateTime('2015-12-25'), '2015-12-25T01:00');
    // local
  ...
  it('Logic', () => {
    ...
    assert.strictEqual(revertToDate.toISOString(), '2018-06-12T17:30:00.000Z');
  });
});
...
describe('inputDateTimeToDate', () => {
  it('String', () => {
    ...
    // - => Iso
    assert.strictEqual(inputDateTimeToDate('2015-12-25T19:30').toISOString(), '2015-12-25T17:30:00.000Z');
    // / => Local
    assert.strictEqual(inputDateTimeToDate('2015/12/25T19:30').toISOString(), '2015-12-25T17:30:00.000Z');
    assert.strictEqual(inputDateTimeToDate('2018-06-12T19:30').toISOString(), '2018-06-12T17:30:00.000Z');
  });
});
